      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Container(
            ...
            child: Row(children: List.generate(tabsList.length, (index) {
              return tabs(tabsList[index],index);
            }),),
          ),
          if (selectedTabIndex==0) Expanded(child: ChartersView())
          else if (selectedTabIndex==1) Expanded(child: ExperiencesView())
          else Expanded(child: HostView()),
