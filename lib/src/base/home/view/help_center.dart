...
class _HelpCenterState extends State<HelpCenter> {
  ...
  TextEditingController fullNameCon = TextEditingController(
      text:
          "${Get.context!.read<AuthVm>().userModel?.firstName ?? ""} ${Get.context!.read<AuthVm>().userModel?.lastName ?? ""}");
  TextEditingController emailController = TextEditingController(
      text: Get.context!.read<AuthVm>().userModel?.email ?? "");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: GeneralAppBar.simpleAppBar(
          context, getTranslated(context, "yachtmaster_support") ?? ""),
      body: Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (val) => FieldValidator.validateFullName(
                      ...
                      TextFormField(
                        ...
                        controller: descCon,
                        validator: (val) =>
                            FieldValidator.validateDesc(descCon.text.trim()),
                            ...
                            try {
                              ...
                              await FlutterEmailSender.send(email)
                                ...
                                Helper.inSnackBar(
                                    ...
                                    R.colors.themeMud);
                                NeighborhoodSupportModel model =
                                ...
                                await FbCollections.neighborhoodSuppport
                                    .doc(docId)
                                    .set(model.toJson());
                              });
