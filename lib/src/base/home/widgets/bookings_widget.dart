  ...
  Widget build(BuildContext context) {
    return Consumer<HomeVm>(builder: (context, provider, _) {
      ...
      return Padding(
        ...
        child: FutureBuilder(
          future: FbCollections.charterFleet.doc(widget.bookings?.charterFleetDetail?.id).get(),
          builder: (context,AsyncSnapshot<DocumentSnapshot> snapshot) {
            if(!snapshot.hasData)
              ...
              CharterModel charterModel=CharterModel.fromJson(snapshot.data);
              return Stack(
                ...
                children: [
                  if (widget.isLargeView == false)
                    ...
                    ShaderMask(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: CachedNetworkImage(imageUrl:charterModel.images?.first ??R.images.serviceUrl,
                              height: 120.sp,
                              width: Get.width * .85,
                              fit: BoxFit.cover,
                  ...
                  Padding(
                    padding:
                    EdgeInsets.symmetric(horizontal:widget.isLargeView == false ? 0  : 7.w),
                    child: Column(
                      children: [
                        Row(
                          children: [
                            if (widget.isLargeView == true)
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child:CachedNetworkImage(imageUrl:charterModel.images?.first ??
                                        R.images.serviceUrl,
                            ...
                            if (widget.isLargeView == true) SizedBox() else w4,
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: R.textStyle.helvetica().copyWith(
                                        ...
                                        fontWeight: widget.isLargeView == true
                                            ...
                                            : FontWeight.normal,
                                        fontSize:
                                        widget.isLargeView == true ? 13.sp : 11.sp),
                                  ),
                                  h0P7,
                                  Text(
                                  ...
                                  Text(
                                    ...
                                    style: R.textStyle.helvetica().copyWith(
                                        color: R.colors.whiteColor,
                                        fontSize:
                                        widget.isLargeView == true ? 12.sp : 10.sp),
                                  ),
                                  if (widget.isLargeView == true) h4 else h1P5,
                                  Text(
                                    "\$${Helper.numberFormatter(double.parse(widget.bookings?.priceDetaill?.totalPrice.toString().split(".").first??""))}",
                                    style: R.textStyle.helveticaBold().copyWith(
                                        color: R.colors.yellowDark, fontSize: 13.sp),
                                  ),
                                  h0P5,
                                  FutureBuilder(
                                      ...
                                      builder: (context,
                                        ...
                                        if (!hostSnap.hasData) {
                                          ...
                                          return Text(hostSnap.data?.get("first_name"),
