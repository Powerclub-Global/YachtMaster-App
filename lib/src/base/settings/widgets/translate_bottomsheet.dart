...
import '../../../../localization/locale_contants.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              GeneralAppBar.simpleAppBar(
                context,
                getTranslated(context, "translate") ?? "",
  ...
  Widget flags(SettingsVm provider, int index, String title, String img) {
    return GestureDetector(
      onTap: () async {
        ...
        provider.update();
        await setLocale(provider.selectedLang == 2 ? "ar" : "en");
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Image.asset(img, height: Get.height * .04),
                w3,
                Text(
                  title,
                  style: R.textStyle.helveticaBold().copyWith(
