                          ...
                          children: [
                            ...
                            Center(
                              child: RatingBar.builder(
                                ...
                                itemCount: 5,
                                itemSize: 40,
                                glowColor: R.colors.yellowDark.withValues(
                                  alpha: .50,
                                ),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                controller: descCon,
                                validator:
                                    (val) => FieldValidator.validateDesc(
                                      descCon.text,
                                    ),
                    ...
                    children: <Widget>[
                      ...
                      Center(
                        child: RatingBar.builder(
                          ...
                          itemCount: 5,
                          itemSize: 40,
                          glowColor: R.colors.yellowDark.withValues(alpha: .50),
                          unratedColor: R.colors.unratedStar,
                          itemBuilder:
                              (context, _) => Padding(
                                padding: EdgeInsets.only(right: 50),
