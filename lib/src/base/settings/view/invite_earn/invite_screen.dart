                    ...
                    children: [
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Text("https://apps.apple.com/us/app/yachtmaster-app/id6449384419",style: R.textStyle.helvetica().copyWith(
                      ...
                      GestureDetector(
                        onTap: () {
                          Clipboard.setData(
                              const ClipboardData(text: "https://apps.apple.com/us/app/yachtmaster-app/id6449384419"));
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Image.asset(R.images.copying,scale: 4,),
                              w2,
                              Text("${getTranslated(context, "copy")?.toLowerCase()}",style: R.textStyle.helvetica().copyWith(
