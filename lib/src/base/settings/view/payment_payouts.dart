      ...
      builder: (context, homeVm, bookingsVm, provider, _) {
        return Scaffold(
          ...
          appBar: GeneralAppBar.simpleAppBar(
            context,
            getTranslated(context, "payment_status") ?? "",
          ),
          body: Column(
            children: [
              h2,
              ...
              Expanded(
                child:
                    selectedTabIndex == PaymentPayoutsStatus.pending.index &&
                        ...
                        : selectedTabIndex ==
                                PaymentPayoutsStatus.pending.index &&
                            homeVm.allBookings
                                .where(
                                  (element) =>
                                      element.bookingStatus ==
                          ...
                          children: List.generate(
                            ...
                            (index) {
                              ...
                              PaymentModel model = PaymentModel(
                                status: 0,
                                payments:
                                    bookingModel.paymentDetail?.isSplit == true
                                        ? bookingModel
                                            .paymentDetail
                                            ?.splitPayment
                                            ?.map(
                                              (e) => PaymentPayoutsModel(
                                                charterName:
                                                    bookingModel
                                                        .charterFleetDetail
                                                        ?.name,
                        ...
                        : selectedTabIndex ==
                                PaymentPayoutsStatus.received.index &&
                            homeVm.allBookings
                                .where(
                                  (element) =>
                                      element.hostUserUid ==
            ...
            return Column(
              children: [
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          model.payments?[paymentIndex].charterName ?? "",
                        ...
                        FutureBuilder(
                          future:
                              FbCollections.user
                                  .doc(
                                    model.payments?[paymentIndex].paidBy ?? "",
                                  )
                                  .get(),
                          builder: (
                            context,
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "\$${double.parse(model.payments?[paymentIndex].price ?? "").toStringAsFixed(2)}",
                          style: R.textStyle.helvetica().copyWith(
                        ...
                        h0P5,
                        Text(
                          model.payments?[paymentIndex].date ?? "",
                          style: R.textStyle.helvetica().copyWith(
                            color: R.colors.whiteColor,
                            fontSize: 12.sp,
                          ),
                ...
                if (model.payments?.length == 1 ||
                  ...
                  Divider(color: R.colors.whiteColor, height: 3.h),
              ],
            );
          }),
        ),
