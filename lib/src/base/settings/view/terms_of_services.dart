    ...
    return Consumer<SettingsVm>(
        builder: (context, provider,_) {
          return Scaffold(
            ...
            appBar: GeneralAppBar.simpleAppBar(context, provider.allContent.where((element) => element.type==AppContentType.termsOfService.index).first.title??""),
            body: SingleChildScrollView(
              child: Column(children: [
                Container(
                  ...
                  child:
                  HtmlWidget(
                    provider.allContent.where((element) => element.type==AppContentType.termsOfService.index).first.content??"",
