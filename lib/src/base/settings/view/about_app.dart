...
class _AboutAppState extends State<AboutApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GeneralAppBar.simpleAppBar(context, getTranslated(context, "how_yachtmaster_works")??""),
      body:  SingleChildScrollView(
        child: Padding(
          ...
          child:  Column(
                  children: [
                    Container(
                      padding:  EdgeInsets.symmetric(horizontal: Get.width*.04,vertical: Get.height*.008),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Version 1.1.1',
                            style: R.textStyle.helveticaBold()
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  getTranslated(context, 'website')??"",style: R.textStyle.helveticaBold().
                                copyWith(fontSize: 12.sp,color: R.colors.whiteDull),
                                ),
                                Text(
                                  websiteLink??"",
                                  style: R.textStyle.helvetica()
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Text(
                            getTranslated(context, 'follow_us')??"",style: R.textStyle.helvetica().
                          copyWith(fontSize: 14.sp,color: R.colors.whiteColor),
                          ),
                          SizedBox(
                            height: 2.h,
                          ),
                    ...
                    SizedBox(height: 2.h,),
                    Column(children:List.generate(context.read<SettingsVm>().allContent.where((element) => element.type==AppContentType.howYachtWorks.index).length, (index) {
                     ContentModel content= context.read<SettingsVm>().allContent.where((element) => element.type==AppContentType.howYachtWorks.index).toList()[index];
                      return questionAnswer(content.title??"", content.content??"");
                    }),)
            ...
            child: Column(children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(title,style: R.textStyle.helveticaBold().
                  copyWith(color:R.colors.whiteColor ,fontSize: 12.5.sp,height: 1.2),),
                ),
              ),
              Padding(
                padding:  EdgeInsets.symmetric(horizontal: Get.width*.04,vertical: Get.height*.02),
                child: Text(desc.replaceAll("\\n", "\n"),style: R.textStyle.helvetica()
                    .copyWith(color:R.colors.whiteDull ,fontSize: 11.5.sp,height: 1.2)),
              ),
            ],),
          ),
        );
