...
class AppUrlModel {
  AppUrlModel({
    ...
    this.hostPolicies,
      this.adminCryptoEmail,this.is_enable_permission_dialog,this.is_enable_social_login});
...
AppUrlModel copyWith({  String? referralLink,
  String? facebookUrl,
  int? superhostminimumbookings,
  String? websiteUrl,
  bool? is_enable_permission_dialog,
  ...
  is_enable_permission_dialog: is_enable_permission_dialog ?? this.is_enable_permission_dialog,
  is_enable_social_login: is_enable_social_login ?? this.is_enable_social_login,
  superhostminimumbookings: superhostminimumbookings ?? this.superhostminimumbookings,
