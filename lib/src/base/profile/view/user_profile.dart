...
class _UserProfileState extends State<UserProfile> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<HomeVm, BaseVm, AuthVm>(
      builder: (context, homeVm, provider, authVm, _) {
        return Scaffold(
                      ...
                      child: ShaderMask(
                        shaderCallback: (bounds) {
                          return LinearGradient(
                            colors: [
                              ...
                              R.colors.black.withValues(alpha: .02),
                              R.colors.black.withValues(alpha: .85),
                              R.colors.black,
                            ],
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                authVm.userModel?.imageUrl?.isEmpty == true ||
                    ...
                    if (provider.reviews.isEmpty == true)
                      ...
                      Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: List.generate(provider.reviews.length, (
                              index,
                            ) {
