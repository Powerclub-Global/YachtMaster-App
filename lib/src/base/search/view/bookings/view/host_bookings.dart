...
//                             where((element) => element.bookingStatus==BookingStatus.ongoing.index  && element.hostUserUid==firebaseAuthService.currentUserId).toList()[index];
//                             return Padding(
...
//                         provider.allBookings.
//                         where((element) => element.bookingStatus==BookingStatus.completed.index  && element.hostUserUid==firebaseAuthService.currentUserId).toList().isEmpty?
//                     EmptyScreen(
...
//                     bookingsVm.selectedHostBookingTab==BookingStatus.completed.index &&
//                         provider.allBookings.
//                         where((element) => element.bookingStatus==BookingStatus.completed.index && element.hostUserUid==firebaseAuthService.currentUserId).toList().isNotEmpty?
//                     ListView(
//                       children: List.generate(provider.allBookings.
...
//                         provider.allBookings.
//                         where((element) => element.bookingStatus==BookingStatus.canceled.index && element.hostUserUid==firebaseAuthService.currentUserId).toList().isEmpty?
//                     EmptyScreen(
...
//                     ListView(
//                       children: List.generate(provider.allBookings.
//                       where((element) => element.bookingStatus==BookingStatus.canceled.index && element.hostUserUid==firebaseAuthService.currentUserId).toList().length,
//                               (index) {
//                             BookingsModel bookingModel=provider.allBookings.
//                             where((element) => element.bookingStatus==BookingStatus.canceled.index && element.hostUserUid==firebaseAuthService.currentUserId).toList()[index];
//                             return Padding(
//                               padding:  EdgeInsets.symmetric(horizontal: 5.w),
//                               child: GestureDetector(
//                                 onTap: (){
