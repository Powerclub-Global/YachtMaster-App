            ...
            builder: (context, settingsVm, _) {
              return Scaffold(
                ...
                appBar: GeneralAppBar.simpleAppBar(
                  context,
                  getTranslated(context, "confirm_and_pay") ?? "",
                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FutureBuilder(
                                    ...
                                    builder: (
                                      context,
                                      AsyncSnapshot<DocumentSnapshot> hostSnap,
                                    ) {
                                      if (!hostSnap.hasData) {
                                        return SizedBox();
                                      } else {
                          ...
                          child: Column(
                            children: [
                              ...
                              tiles(
                                ...
                                "guests",
                                "${provider.bookingsModel.totalGuest}",
                                isDivider: false,
                              ),
                            ],
                          ),
                              ...
                              Column(
                                children: [
                                  ...
                                  payIn(
                                    ...
                                    "deposit_of_25",
                                    1,
                                    (grandTotal * (25 / 100)).toStringAsFixed(
                                      2,
                                    ),
                                  ),
                                ],
                        ...
                        GestureDetector(
                          onTap: () async {
                            Get.bottomSheet(
                              ...
                              barrierColor: R.colors.grey.withValues(
                                alpha: .20,
                              ),
                            );
                          },
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(R.images.edit, height: Get.height * .017),
              ],
            ),
          ),
          if (isDivider == false)
