  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      if (bookingsModel != null) {
        rentalUser = context.read<BaseVm>().allUsers.firstWhereOrNull(
          (element) => element.uid == bookingsModel?.createdBy,
        );
      }
              ...
              child: Column(
                children: [
                      ...
                      DecoratedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                bookingsModel?.charterFleetDetail?.image ??
                                R.images.serviceUrl,
                  ...
                  if (bookingsModel?.paymentDetail?.isSplit == false &&
                      bookingsModel?.paymentDetail?.splitPayment?.isEmpty ==
                          true)
                    SizedBox()
                  else
                    Container(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        if (bookingsModel?.bookingStatus ==
                  ...
                  h2,
                  if (bookingsModel?.paymentDetail?.remainingAmount == 0.0 ||
      ...
      NotificationModel notificationModel = NotificationModel(
        ...
        hostUserId:
            context
                ...
                .allUsers
                .firstWhereOrNull(
                  (element) => element.uid == bookingsModel?.hostUserUid,
                )
                ?.uid ??
            "",
        title: "Cancel Alert",
