    ...
    try {
      ...
      if (isTip == false) {
        ...
        await FbCollections.mail.add({
          "to": [hostUser.email],
          "message": {
            "subject": "Booking Confirmation by YachtMaster App",
            "text":
  ...
  <style>
    * {
    ...
    @media (max-width:768px) {
      ...
      .row-5 .column-1 .block-12.divider_block .alignment table,
      .row-5 .column-1 .block-8.divider_block .alignment table {
        display: inline-table;
      }

      .row-5 .column-1 .block-12.divider_block .alignment,
      .row-5 .column-1 .block-8.divider_block .alignment {
        text-align: left !important;
        font-size: 1px;
      }
    }
...
<body class="body"
  style="margin: 0; background-color: #000000; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
                    ...
                    <tbody>
                      <tr>
                        <td class="column column-1"
                          ...
                          width="100%">
                          <div class="spacer_block block-1" style="height:55px;line-height:55px;font-size:1px;"> </div>
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-2"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #ffffff; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
                                  <span class="tinyMce-placeholder" style="word-break: break-word;">Booking Confirmation by YachtMaster App</span>
                                </h1>
                              </td>
                            </tr>
                          </table>
            ...
            <tbody>
              <tr>
                <td>
                  <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                    role="presentation"
                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; border-radius: 0; color: #000000; width: 900px; margin: 0 auto;"
                    width="900">
                    <tbody>
                      <tr>
                        <td class="column column-1"
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                      <td class="divider_inner"
                                        style="font-size: 1px; line-height: 1px; border-top: 1px solid #ffd700;"><span
                        ...
                        <td class="column column-1"
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-1"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#ffffff;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0;">Thank you for booking with YachtMaster App. You're all set
                                    ${authVm.userModel!.firstName} ${authVm.userModel!.lastName}!. Your booking for
                                    ${charter.get("name")} is confirmed for
                                    ${DateFormat('dd/MM/yyyy').format(bookingsModel.schedule!.dates![0].toDate())} from
                                    ${bookingsModel.schedule!.startTime} to
                                    ${DateFormat('dd/MM/yyyy').format(bookingsModel.schedule!.dates![1].toDate())}
                                    ${bookingsModel.schedule!.endTime}. </p>
                                </div>
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td class="pad" style="width:100%;">
                                <div align="center" class="alignment" style="line-height:10px">
                                  <div style="max-width: 900px;"><img height="auto" src=${charter.get("images")[0]}
                                      style="display: block; height: auto; border: 0; width: 100%;" width="900" /></div>
                                </div>
                              </td>
                            </tr>
                          </table>
                    ...
                    <tbody>
                      <tr>
                        <td class="column column-1"
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-1"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#ffffff;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0;">Use link below to easily modify or contact your host. This
                                    should be done up to 24 hours after placing the booking.</p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-3"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#ffffff;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0; margin-bottom: 16px;">Total guests: ${bookingsModel.totalGuest}
                                  </p>
                                  <p style="margin: 0;"><br />If the number or guests should change please reach out to
                                    your host to be sure accommodations can be made. Guests limits apply. </p>
                                </div>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-5"
                            ...
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #ffffff; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
                                  <span class="tinyMce-placeholder" style="word-break: break-word;">Location :
                                    ${charter.get("location")["adress"]} <br /></span>
                                </h1>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-7"
                            ...
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #ffffff; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
                                  <span class="tinyMce-placeholder" style="word-break: break-word;">Host Details</span>
                                </h1>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="0" cellspacing="0" class="divider_block block-8"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-top:10px;">
                                <div align="left" class="alignment">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="70%">
                                    <tr>
                                      <td class="divider_inner"
                                        style="font-size: 1px; line-height: 1px; border-top: 1px solid #ffd700;"><span
                                          style="word-break: break-word;"> </span></td>
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  ...
                                  <p style="margin: 0; margin-bottom: 16px;"><strong>Email ID:</strong>
                                    ${hostUser.email}</p>
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-11"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad">
                                <h1
                                  style="margin: 0; color: #ffffff; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
                                  <span class="tinyMce-placeholder" style="word-break: break-word;">Payment
                                    Details</span>
                                </h1>
                              </td>
                            </tr>
                          </table>
                          <table border="0" cellpadding="0" cellspacing="0" class="divider_block block-12"
                            role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                            <tr>
                              <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-top:10px;">
                                <div align="left" class="alignment">
                          ...
                          <table border="0" cellpadding="10" cellspacing="0" class="paragraph_block block-3"
                            ...
                            <tr>
                              <td class="pad">
                                <div
                                  style="color:#ffffff;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                  <p style="margin: 0; margin-bottom: 16px;"><strong>Cancellation Policy</strong></p>
                                  <p style="margin: 0; margin-bottom: 16px;">If you cancel your booking any deposit or
                                    payments made are non refundable. </p>
                                </div>
                              </td>
                            </tr>
                          </table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://apps.apple.com/in/app/yachtmaster-app/id6449384419" style="height:42px;width:384px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#7747FF">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#ffffff;font-family:Arial, sans-serif;font-size:16px">
<![endif]--><a href="https://apps.apple.com/in/app/yachtmaster-app/id6449384419"
                                    ...
                                    target="_blank"><span
                                      style="word-break: break-word; padding-left: 20px; padding-right: 20px; font-size: 16px; display: inline-block; letter-spacing: normal;"><span
                                        style="word-break: break-word; line-height: 32px;"><strong>Get instant access
                                          with the YachtMaster
                                          App.</strong></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                </div>
                              </td>
                            </tr>
                          </table>
                          ...
                          <div class="alignment" align="center">
                            <table class="social-table" width="144px" border="0" cellpadding="0" cellspacing="0"
                              ...
                              <tr>
                                ...
                                <td style="padding:0 2px 0 2px;"><a href="https://www.twitter.com/" target="_blank"><img
