                ...
                appBar: AppBar(
                  ...
                  title: Container(
                    decoration: BoxDecoration(
                      ...
                      color: R.colors.grey.withValues(alpha: .15),
                    ),
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (value) {
                        ...
                        if (yachtVm.charterCities
                            .where(
                              (element) => element.removeAllWhitespace
                                  .toLowerCase()
                                  .toString()
                        ...
                        provider.update();
                        log(
                          "______________________RECEN LEN:${provider.recentSearchCities.length}",
                        );
                      },
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              getTranslated(context, "where_you_going") ?? "",
          ...
          Row(
            children: [
              ClipRRect(
                ...
                child: Image.asset(R.images.v1, height: Get.height * .09),
              ),
              w4,
              Column(
