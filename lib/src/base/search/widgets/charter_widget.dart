...
class _CharterWidgetState extends State<CharterWidget> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      averageRating = settingsVm.averageRating(
        settingsVm.allReviews
            .where((element) => element.hostId == widget.charter?.createdBy)
            .toList(),
      );
      setState(() {});
    });
            ...
            child: Stack(
              ...
              children: [
                            ...
                            children: [
                              Text(
                                ...
                                style: R.textStyle.helveticaBold().copyWith(
                                  ...
                                  fontSize: widget.isSmall ? 11.sp : 15.sp,
                                ),
                              ...
                              Text(
                                ...
                                style: R.textStyle.helvetica().copyWith(
                                  color: R.colors.whiteDull,
                                  fontSize: widget.isSmall ? 7.sp : 12.sp,
                                ),
                                overflow: TextOverflow.ellipsis,
                              ),
                            ],
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: R.textStyle.helvetica().copyWith(
                                        color: R.colors.yellowDark,
                                        fontSize: widget.isSmall ? 8.sp : 12.sp,
                                      ),
                                      maxLines: 2,
                ...
                if (widget.isShowStar == false ||
                  ...
                  Positioned(
                    top: 10,
                    right: widget.isPopUp == true ? 10.w : 2.w,
  ...
  String getStartingFromText() {
    ...
    if ((widget.charter?.priceFourHours ?? 0) != 0) {
      text =
          "\$${Helper.numberFormatter(double.parse(widget.charter?.priceFourHours?.toStringAsFixed(0) ?? ""))}";
    } else if ((widget.charter?.priceHalfDay ?? 0) != 0) {
      text =
          "\$${Helper.numberFormatter(double.parse(widget.charter?.priceHalfDay?.toStringAsFixed(0) ?? ""))}";
    } else if ((widget.charter?.priceFullDay ?? 0) != 0) {
      text =
          "\$${Helper.numberFormatter(double.parse(widget.charter?.priceFullDay?.toStringAsFixed(0) ?? ""))}";
    }
    return text;
  }
}
