...
class AdminChatHeadModel {
  ...
  AdminChatHeadModel.fromJson(dynamic json) {
    lastMessage = json['last_message'] != null
        ? AdminChatModel.fromJson(json['last_message'])
        : null;
    id = json['id'];
  ...
  AdminChatModel? lastMessage;
  String? id;
  List<String>? users;
  int? status;
  Timestamp? createdAt;
  AdminChatHeadModel copyWith({
    AdminChatModel? lastMessage,
    String? id,
    List<String>? users,
    int? status,
