            ...
            child: FutureBuilder(
              future:
                  FbCollections.charterFleet
                      .doc(widget.reviewModel?.charterFleetDetail?.id)
                      .get(),
                  ...
                  return ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: charter.images?.first ?? R.images.serviceUrl,
                        height: Get.height * .25,
                        fit: BoxFit.cover,
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              h0P3,
                              Text(
                                (widget.reviewModel?.createdAt?.toDate() ?? now)
                                    .formateDateMDY(),
                                style: R.textStyle.helvetica().copyWith(
                                  color: R.colors.whiteColor,
                                  fontSize: 10.sp,
                      ...
                      h2,
                      Text(
                        widget.reviewModel?.description ?? "",
                        style: R.textStyle.helvetica().copyWith(
                          color: R.colors.whiteColor,
                          fontSize: 10.sp,
                        ),
