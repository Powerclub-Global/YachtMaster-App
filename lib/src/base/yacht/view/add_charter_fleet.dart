  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      if (isEdit == true) {
        ...
        /// TODO SET PRICES
        priceEightCon.text =
            charterModel?.priceHalfDay != 0
                ? charterModel?.priceHalfDay?.toString() ?? ""
                : "";
        priceFullCon.text =
            charterModel?.priceFullDay != 0
                ? charterModel?.priceFullDay?.toString() ?? ""
                : "";
        priceFourCon.text =
            charterModel?.priceFourHours != 0
        ...
        locationLatLng = LatLng(
          charterModel?.location?.lat ?? 25.7716239,
        ...
        return ModalProgressHUD(
          ...
          child: Scaffold(
            ...
            appBar: GeneralAppBar.simpleAppBar(
              context,
              getTranslated(context, "charter_fleet") ?? "",
            ),
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Expanded(
                              child: SizedBox(
                                ...
                                child: ListView(
                                  ...
                                  children:
                                      networkImagesList
                                          .map((e) => imageNetwork(e, provider))
                                          .toList()
                                        ..addAll(
                                          fileImages
                                              .map((e) => imgFile(e, provider))
                                              .toList(),
                                        ),
                                ),
                              ),
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          label(getTranslated(context, "charter_name") ?? ""),
                          h0P5,
                          TextFormField(
                            focusNode: nameFn,
                          ...
                          h1P5,
                          label(getTranslated(context, "sub_heading") ?? ""),
                          h0P5,
                          TextFormField(
                          ...
                          TextFormField(
                            ...
                            onTap: () {
                              Get.to(
                                PickLocation(selectedLatLng: locationLatLng),
                              )?.then((value) {
                                var result = value;
                                Map<String, dynamic>;
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              if (formKey.currentState!.validate()) {
                                if (provider.charterModel?.availability ==
                                        null ||
                                    provider
                                            .charterModel
                                            ?.availability
          ...
          Container(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color:
                    isPetAllow == index ? R.colors.black : Colors.transparent,
              ),
            ),
          ),
          w3,
              ...
              children: [
                Text(
                  index == 8 &&
                      ...
                      ? "${yachtVm.charterModel?.yachtRules?.title}"
                      : index == 5 &&
                          (provider.start != null && provider.end != null)
                    ...
                    color:
                        index == 7 &&
                                ...
                                index == 6 &&
                                    (yachtVm.charterModel?.yachtRules?.title !=
                                            "" &&
                                        yachtVm.charterModel?.yachtRules !=
                                            null) ||
                                index == 5 &&
                                    (provider.start != null &&
                                        provider.end != null) ||
