                            ...
                            onTap: () {
                              Get.bottomSheet(
                                SureBottomSheet(
                                  title: "Delete Yacht",
                                  subTitle:
                                      "Are you sure you want to delete this yacht?",
                                  yesCallBack: () async {
                                    Get.back();
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              "${currentIndex + 1}/${yacht?.images?.length ?? 0}",
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "\$${Helper.numberFormatter(double.parse(yacht?.price?.toStringAsFixed(0) ?? "23,124"))}",
                                      style: R.textStyle
                                          .helveticaBold()
                                          .copyWith(
