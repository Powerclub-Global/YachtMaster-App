...
class _LoginScreenState extends State<LoginScreen> {
          ...
          child: Scaffold(
            ...
            body: Form(
              ...
              child: Column(
                children: [
                  h5,
                  Image.asset(R.images.logo, scale: 3),
                  h5,
                  Text(
                    ...
                    child: Padding(
                      ...
                      child: ListView(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (_loginKey.currentState!.validate()) {
                                ...
                                await provider.onClickLoginOTP(
                                  countryCode.trim(),
                          ...
                          h9,
                          if (Provider.of<BookingsVm>(
                                context,
                                listen: false,
                              ).appUrlModel?.is_enable_social_login ==
                              true) ...[
                            Row(
                              children: [
                                Expanded(
                                  child: Divider(
                                    color: R.colors.grey.withValues(alpha: .50),
                                    thickness: 1,
                                  ),
                                ),
                                Expanded(
  ...
  Widget socialLinks(String img, Function() callBack) {
    return GestureDetector(
      onTap: callBack,
      child: Image(height: 42, image: AssetImage(img)),
    );
  }
}
