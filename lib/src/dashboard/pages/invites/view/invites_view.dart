...
import 'package:yacht_master_admin/src/dashboard/pages/invites/view/widgets/invites_data_grid_source.dart';
...
class _InviteViewState extends State<InviteView> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      requestDataGridSource = InvitesDataGridSource(isWebOrDesktop: true);
      Get.forceAppUpdate();
    });
    super.initState();
  }
