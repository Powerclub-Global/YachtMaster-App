...
class AppDecorations {
  static InputDecoration suffixTextField(
    ...
    return InputDecoration(
      ...
      suffixIconConstraints: BoxConstraints(
          maxWidth: 50, minHeight: 30, maxHeight: 30, minWidth: 50),
      filled: true,
      ...
      enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: R.colors.black)),
      focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: R.colors.themeMud)),
  ...
  static InputDecoration simpleTextField(
    String? hint,
    TextStyle? hintStyle,
  ) {
    return InputDecoration(
      ...
      labelStyle: R.textStyle
          .helvetica()
          .copyWith(color: R.colors.charcoalColor, fontSize: 9.sp),
      filled: true,
      fillColor: R.colors.whiteColor,
      isDense: true,
      enabledBorder: OutlineInputBorder(
  ...
  static InputDecoration generalTextField(
    String? hint,
    TextStyle? hintStyle,
  ) {
    return InputDecoration(
  ...
  static InputDecoration greyTextField(String? hint, {Widget? prefixIcon}) {
    return InputDecoration(
      ...
      hintStyle: R.textStyle
          .helvetica()
          .copyWith(color: R.colors.whiteColor, fontSize: 11.sp),
    );
  }
  ...
  static BoxDecoration cardsDecoration(
      {Color? borderColor, double? borderWidth = 1, double? radius = 10}) {
    return BoxDecoration(
  ...
  static BoxDecoration cardsDecorationColored(Color color,
      [double? radius = 10, Color? borderColor = Colors.grey]) {
    return BoxDecoration(
        color: color,
        borderRadius: BorderRadius.circular(radius!),
...
Widget label(String label, {double fs = 10}) {
  return Text(
    ...
    style: R.textStyle
        .helvetica()
        .copyWith(color: R.colors.whiteColor, fontSize: fs.sp),
  );
}
