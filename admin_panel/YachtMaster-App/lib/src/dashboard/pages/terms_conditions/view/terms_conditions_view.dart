              ...
              child: Container(
                ...
                child: GlobalWidgets.scrollerWidget(
                  ...
                  child: ListView(
                    ...
                    children: [
                      HtmlWidget(
                        context.read<SettingsVM>().allContent.firstWhereOrNull((element) => element.type==AppContentType.termsOfService.index)?.content ?? "",
        ...
        children: [
          ...
          SizedBox(
            ...
            child: AppButton(
              ...
              onTap: ()  {
                Get.dialog(AddTermsDialog(text:context.read<SettingsVM>().allContent.firstWhereOrNull((element) => element.type==AppContentType.termsOfService.index)?.content ?? "",label: "terms_and_condition",contentType: AppContentType.termsOfService, docId: "hzWZguzrOCWUyBRN2eZx",)).then((value) => setState((){}));
              }
            ),
          )
